    ...
    function initMap() {
        ...
        try {
            ...
            var kaybicInfo = new google.maps.InfoWindow({
                content: '<div style="padding: 10px;"><h4>KAYBIC AFRICA</h4><p>Riviera Palmeraie, Cité du Bonheur<br>Abidjan, Côte d\'Ivoire<br><strong>Tél:</strong> +2252530000869<br><strong>Email:</strong> Contact@kaybicafrica.ci</p></div>'
            });
